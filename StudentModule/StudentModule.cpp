...
int main() {
	...
	m.push_back(Module{ "Object Orientated Programming", "COM326", 20, 90 });
	m.push_back(Module{ "Data Structures", "COM321", 20,60 });

	// Calling the custom constructor 2
	Student stu1("Jeni Watt", "Watt-j@ulster.ac.uk", "B004568656", "BSc Computing", 1, m);
	//stu1.ToString();
	//cout << "Status: " << stu1.CalculateClassification() << endl;

	cout << "\nCalling ToString from Student Class\n";
	cout << stu1.ToString() << endl;
	cout << stu2.ToString() << endl;
	cout << end1 << endl;
